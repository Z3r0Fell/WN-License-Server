...
EDITABLE_KEYS: dict[str, dict] = {
    ...
    # ---- Updates (update-channel manifest served by /api/updates/manifest) ----
    "UPDATES_LATEST_VERSION":      {"category": "updates", "secret": False,
                                     "label": "Latest version",
                                     "help": "e.g. 1.0.1. The client shows an update when this exceeds its own version."},
    "UPDATES_RELEASE_DATE":        {"category": "updates", "secret": False,
                                     "label": "Release date",
                                     "help": "ISO date, e.g. 2026-08-09."},
    "UPDATES_RELEASE_NOTES":       {"category": "updates", "secret": False,
                                     "label": "Release notes",
                                     "help": "Short summary shown in the update banner."},
    "UPDATES_CHANGELOG":           {"category": "updates", "secret": False,
                                     "label": "Changelog URL",
                                     "help": "Link to the full changelog."},
    "UPDATES_DOWNLOAD_URL":        {"category": "updates", "secret": False,
                                     "label": "Download URL",
                                     "help": "Where users get the new build. Empty = the GitHub Releases page."},
    "UPDATES_SIZE_MB":             {"category": "updates", "secret": False,
                                     "label": "Download size (MB)",
                                     "help": "Approximate installer size for the update banner."},
    "UPDATES_MANDATORY":           {"category": "updates", "secret": False,
                                     "label": "Mandatory update",
                                     "help": "true forces the update banner for all older versions."},
    "UPDATES_MIN_VERSION":         {"category": "updates", "secret": False,
                                     "label": "Minimum version",
                                     "help": "Oldest version that can update directly. Default 1.0.0."},
}
